...
def app():
    ...
    st.title('Musical Notes Symbol Classification')
    st.subheader('by David Bryan S. Barcelona, BSCS 3A, WVSU College of ICT')
    ...
    if st.button('Start'):
        df = pd.read_csv('musical_notes.csv', header=None)
